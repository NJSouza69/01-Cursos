...
SELECT * FROM tipo_conta ORDER BY pk_tipo_conta ASC; 
...
SELECT * FROM conta ORDER BY pk_conta ASC; 
...
SELECT * FROM tipo_transacao ORDER BY pk_tipo_transacao ASC; 
...
SELECT * FROM categorias ORDER BY pk_categoria ASC; 
...
SELECT * FROM sub_categorias ORDER BY pk_sub_categoria ASC; 
...
SELECT * FROM tipo_despesas ORDER BY pk_tipo_despesa ASC; 
...
INSERT INTO movimento_bancario (fk_tipo_conta, fk_categoria, fk_sub_categoria, fk_conta, fk_tipo_despesa, fk_tipo_transacao, conta_destino, descricao, valor, data_liquidacao) 
	VALUES (1,1,1,1,1,1,2,'Reforma cadeiras escritório',600.00,'2022-08-14');
INSERT INTO movimento_bancario (fk_tipo_conta, fk_categoria, fk_sub_categoria, fk_conta, fk_tipo_despesa, fk_tipo_transacao, conta_destino, descricao, valor, data_liquidacao) 
	VALUES (1,1,1,1,1,1,2,'Retrovisor Gol',431.00,'2022-10-14');
INSERT INTO movimento_bancario (fk_tipo_conta, fk_categoria, fk_sub_categoria, fk_conta, fk_tipo_despesa, fk_tipo_transacao, conta_destino, descricao, valor, data_liquidacao) 
	VALUES (1,1,1,1,1,1,2,'Aniversário Beatriz',325.60,'2022-10-27');
INSERT INTO movimento_bancario (fk_tipo_conta, fk_categoria, fk_sub_categoria, fk_conta, fk_tipo_despesa, fk_tipo_transacao, conta_destino, descricao, valor, data_liquidacao) 
	VALUES (1,1,1,1,1,1,2,'Filtro Cavalete',62.00,'2022-07-11');
INSERT INTO movimento_bancario (fk_tipo_conta, fk_categoria, fk_sub_categoria, fk_conta, fk_tipo_despesa, fk_tipo_transacao, conta_destino, descricao, valor, data_liquidacao) 
	VALUES (1,1,1,1,1,1,2,'Espetinho e Sorvete',50.00,'2022-11-9');

SELECT * FROM movimento_bancario ORDER BY data_liquidacao ASC; 
